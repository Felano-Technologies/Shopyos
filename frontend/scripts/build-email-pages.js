...
const outDir = path.resolve(__dirname, '..', 'public', 'emails');
...
const pages = {
  ...
  "04-order-confirmed.html": layout({
    ...
    body: `<p>Hi <strong>Abena</strong>,</p><p>Thanks for shopping on Shopyos. Here is your order summary.</p>${item("F", "Fresh Tilapia (1kg)", "Qty: 2 - Kumasi Fish Market", "GH₵ 48.00")}${item("J", "Jollof Rice + Chicken", "Qty: 1 - Mama's Kitchen", "GH₵ 35.00")}<table role="presentation" class="total" width="100%"><tr><td>Subtotal</td><td class="price">GH₵ 83.00</td></tr><tr><td>Delivery</td><td class="price">GH₵ 8.00</td></tr><tr><td>Discount</td><td class="price">-GH₵ 5.00</td></tr><tr class="final"><td>Total paid</td><td class="price">GH₵ 86.00</td></tr></table>${details([["Delivery address", "Asokwa, Kumasi"], ["Estimated delivery", "Today, 2-4 PM"], ["Payment", "Mobile Money ****4821"], ["Order ID", "#SHP-20847"]])}${button("Track order", "green")}`
  }),
  ...
  "07-abandoned-cart.html": layout({
    ...
    body: `<p>Hi <strong>Akosua</strong>,</p><p>You left these items in your cart. We saved them so you can pick up where you left off.</p>${item("B", "Blue Ankara Tote", "Qty: 1 - Adinkra Studio", "GH₵ 72.00")}${item("S", "Shea Butter Set", "Qty: 2 - Northern Naturals", "GH₵ 54.00")}${button("Return to cart", "green")}<div class="note"><p>Popular local items can sell quickly, and seller availability may change.</p></div>`
  }),
  "08-weekly-deals.html": layout({
    ...
    body: `<p>Hi <strong>Kwame</strong>,</p><p>Here are a few deals worth checking out this week.</p><table role="presentation" class="products"><tr><td><div class="product"><div class="product-name">Fresh Tilapia Pack</div><div class="product-price">GH₵ 42.00</div><span class="pill">15% off</span></div></td><td><div class="product"><div class="product-name">Ankara Tote Bag</div><div class="product-price">GH₵ 61.00</div><span class="pill">New deal</span></div></td></tr><tr><td><div class="product"><div class="product-name">Shea Butter Set</div><div class="product-price">GH₵ 45.00</div><span class="pill">Bundle</span></div></td><td><div class="product"><div class="product-name">Jollof Lunch Box</div><div class="product-price">GH₵ 28.00</div><span class="pill">Today only</span></div></td></tr></table>${button("Shop weekly deals", "green")}`
  })
};
...
console.log(`Wrote ${Object.keys(pages).length} email templates to ${outDir}`);
