...
const styles = StyleSheet.create({
  ...
  // Card Styles
  orderCard: { backgroundColor: '#FFF', borderRadius: 20, marginBottom: 14, padding: 10, shadowColor: "#000", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.05, shadowRadius: 10, elevation: 4 },
  cardHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  storeNameRow: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  storeName: { fontSize: 12, fontFamily: 'Montserrat-Bold', color: '#64748B' },
  ...
  cardBody: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 10, borderTopWidth: 1, borderBottomWidth: 1, borderColor: '#F1F5F9' },
  orderInfo: { gap: 4 },
  orderNumberText: { fontSize: 12, fontFamily: 'Montserrat-Bold', color: '#0C1559' },
  ...
  amountText: { fontSize: 14, fontFamily: 'Montserrat-Bold', color: '#111827' },
  ...
  viewDetailsText: { fontSize: 12, fontFamily: 'Montserrat-SemiBold', color: '#0C1559' },
