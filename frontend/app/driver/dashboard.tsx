...
const MOCK_REQUESTS = [
  {
    id: '1',
    restaurant: 'KFC - Asokwa',
    destination: 'KNUST Campus, Brunei',
    price: 25.00,
    distance: '4.2 km',
    time: '15 mins',
    items: 3,
...
export default function Dashboard() {
  ...
  const toggleOnline = () => {
    ...
    if (!isOnline) {
      // Simulate finding orders after going online
      setTimeout(() => setRequests(MOCK_REQUESTS), 1500);
    } else {
      setRequests([]);
    }
  };

  const RequestCard = ({ item }: { item: typeof MOCK_REQUESTS[0] }) => (
    <View style={styles.requestCard}>
      ...
      <View style={styles.cardFooter}>
        ...
        <TouchableOpacity 
            ...
            onPress={() => router.push('/driver/activeOrder' as any)}
        >
