...
export default function CartScreen() {
  ...
  // where the order ships. Shared with checkout.tsx and home.tsx's header —
    ...
    <View style={styles.container}>
      ...
      {cartItems.length > 0 && (
        <View style={styles.summaryContainer}>
          {deliveryCoords && (
            <TouchableOpacity accessibilityLabel="Change delivery location" accessibilityRole="button" style={styles.deliveryLocationRow} onPress={() => setMapVisible(true)}>
      ...
      <LocationPickerModal
        ...
        onConfirmed={() => router.push('/checkout' as any)}
      />
    </View>
  );
}
