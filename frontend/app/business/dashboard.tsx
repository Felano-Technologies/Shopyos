...
const BusinessDashboard = () => {
  ...
  const recentOrders = [
    { _id: '1', orderNumber: 'ORD-8821', totalAmount: 150, status: 'completed', createdAt: new Date() },
    { _id: '2', orderNumber: 'ORD-8822', totalAmount: 200, status: 'pending', createdAt: new Date() },
    { _id: '3', orderNumber: 'ORD-8823', totalAmount: 75.50, status: 'processing', createdAt: new Date() },
  ];
  ...
  // --- Render Dashboard if Business Exists ---
  // If no business, we show an empty view behind the modal (or just the modal itself)
  const stats = selectedBusiness ? getBusinessStats(selectedBusiness) : { totalProducts: 0, totalOrders: 0, pendingOrders: 0 };
...
const styles = StyleSheet.create({
  ...
  iconBtn: { width: 40, height: 40, borderRadius: 12, backgroundColor: 'rgba(255,255,255,0.15)', justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)', position: 'relative' },
  badgeContainer: { position: 'absolute', top: -5, right: -5, backgroundColor: '#EF4444', minWidth: 18, height: 18, borderRadius: 9, justifyContent: 'center', alignItems: 'center', borderWidth: 1.5, borderColor: '#0C1559', paddingHorizontal: 3 },
  badgeText: { color: '#FFF', fontSize: 9, fontFamily: 'Montserrat-Bold', textAlign: 'center', lineHeight: 11 },
  ...
  actionIconBox: { width: 50, height: 50, borderRadius: 16, justifyContent: 'center', alignItems: 'center', marginBottom: 8, shadowColor: "#000", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 5, elevation: 3 },
  actionLabel: { fontSize: 11, fontFamily: 'Montserrat-SemiBold', color: '#334155', textAlign: 'center' },
