...
const getStyles = (c: ThemeColors) => StyleSheet.create({
  ...
  paragraph: { fontSize: 14, fontFamily: 'Montserrat-Medium', color: c.textSecondary, lineHeight: 21, marginBottom: 12, textAlign: 'left', alignSelf: 'stretch' },
  bulletList: { alignSelf: 'stretch', marginBottom: 12 },
  bullet: { fontSize: 14, fontFamily: 'Montserrat-Medium', color: c.text, lineHeight: 24 },
