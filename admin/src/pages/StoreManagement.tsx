...
import {
  FiCheckCircle, FiXCircle, FiClock, FiShoppingBag, FiX, FiExternalLink, FiSearch, FiTrash2, FiEye,
} from 'react-icons/fi';
import {
  getAdminStores, getAdminStoreStats, adminVerifyStore, adminDeleteStore,
  getStoreLivenessAdmin, getLivenessFrameSignedUrl,
} from '../services/admin';
...
export const StoreManagement: React.FC = () => {
  ...
  const openReview = (store: any) => {
    ...
    getStoreLivenessAdmin(store.id)
