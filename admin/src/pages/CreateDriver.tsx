...
export const CreateDriver: React.FC = () => {
  return (
    <div className="p-8">
      ...
      <p className="text-secondary mb-8">Manually onboard a new parcel partner</p>
      
      <div className="bg-card rounded-2xl border border-border p-6 max-w-2xl">
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-semibold text-body mb-1">Driver Name</label>
          ...
          <div>
            <label className="block text-sm font-semibold text-body mb-1">Vehicle Type</label>
