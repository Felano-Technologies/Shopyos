      ...
      <div className="flex flex-col gap-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-secondary mt-1">Manage the product categories buyers browse by.</p>
          </div>
          <button
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="relative bg-card p-4 rounded-xl shadow-sm border border-border overflow-hidden">
            ...
            <p className="text-xl font-bold text-body">{loading ? '...' : categories.length.toLocaleString()}</p>
            <p className="text-xs font-semibold text-secondary mt-1">Total Categories</p>
          ...
          <div className="relative bg-card p-4 rounded-xl shadow-sm border border-border overflow-hidden">
            ...
            <p className="text-xl font-bold text-body">{loading ? '...' : totalProducts.toLocaleString()}</p>
            <p className="text-xs font-semibold text-secondary mt-1">Categorized Products</p>
                ...
                <tbody className="divide-y divide-border">
                  {loading ? (
                    ...
                    <tr key={cat.id} className="hover:bg-surface-muted/50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <span className="px-2.5 py-1 rounded-md text-xs font-semibold bg-surface-muted text-secondary">
                          {cat.product_count ?? 0} product{cat.product_count === 1 ? '' : 's'}
                        </span>
                      </td>
                      <td className="px-6 py-4">
                        <div className="flex items-center justify-end gap-1">
                          <button onClick={() => openEditModal(cat)} className="p-2 text-subtle hover:text-navy hover:bg-surface-muted rounded-lg transition-colors" title="Edit">
