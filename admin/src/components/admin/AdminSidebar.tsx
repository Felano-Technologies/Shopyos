...
import { FiHome, FiUsers, FiShoppingBag, FiTruck, FiSettings, FiFileText, FiTag, FiClock, FiSend, FiPercent, FiAlertCircle, FiCreditCard, FiMap, FiMonitor, FiBell, FiDollarSign as FiDollar, FiMessageSquare, FiLogOut, FiPieChart, FiTrendingDown, FiPhoneCall, FiShield, FiMapPin } from 'react-icons/fi';
...
export const AdminSidebar: React.FC = () => {
  ...
  const navItems = [
    ...
    { name: 'Change Requests', path: '/verification-change-requests', icon: <FiMapPin className="w-5 h-5" /> },
