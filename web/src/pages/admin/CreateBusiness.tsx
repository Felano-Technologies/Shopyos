...
export const CreateBusiness: React.FC = () => {
  return (
    <div className="p-8">
      ...
      <p className="text-slate-500 mb-8">Manually register a new seller store</p>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 max-w-2xl">
        <div className="space-y-4">
          ...
          <div>
            ...
            <input type="email" className="w-full px-4 py-2 rounded-xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-navy/10 focus:border-navy" />
          </div>
